...
_ISTR_dir = os.path.realpath(os.path.dirname(_src_dir))
def add_ISTR_config(cfg):
    ...
    # Encoder
    cfg.MODEL.ISTR.PATH_COMPONENTS = f"{_ISTR_dir}/LME/coco_2017_train_class_agnosticTrue_whitenTrue_sigmoidTrue_60_siz28.npz"
